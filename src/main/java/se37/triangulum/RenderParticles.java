...
public class YourModParticleEffects {
	...
	if (mc != null && mc.renderViewEntity != null && mc.effectRenderer != null) {
		...
		if (particleName.equals("beamParticle")) {
		    var21 = new EntityBlueDustFX(theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12);
		};
